...
public class ResponseCode {
    ...
    public static final ResponseCode AUTH_FAILURE = new ResponseCode(0, "AUTH_FAILURE",
    ...
    public static final ResponseCode AUTH_CHALLENGE = new ResponseCode(2, "AUTH_CHALLENGE",
    ...
    public static final ResponseCode SERVER_PIN_PROVIDED = new ResponseCode(3, "SERVER_PIN_PROVIDED",
            "Server PIN has been provided.");
    ...
    public static final ResponseCode USER_PIN_CHANGE = new ResponseCode(4, "USER_PIN_CHANGE",
    ...
    public static final ResponseCode OUTER_WINDOW_AUTH = new ResponseCode(5, "OUTER_WINDOW_AUTH",
    ...
    public static final ResponseCode CHANGE_STATIC_PASSWORD = new ResponseCode(6, "CHANGE_STATIC_PASSWORD",
            "Your static password needs to be updated.");
    ...
    public static final ResponseCode STATIC_CHANGE_FAILED = new ResponseCode(7, "STATIC_CHANGE_FAILED",
            "The new static password does not meet policy requirements. Please choose a stronger password and try again.");
    ...
    public static final ResponseCode PIN_CHANGE_FAILED = new ResponseCode(8, "PIN_CHANGE_FAILED",
            "The provided PIN does not meet policy requirements. Please choose a stronger PIN and try again.");
    ...
    public static final ResponseCode FAKE_CHALLENGE = new ResponseCode(9, "FAKE_CHALLENGE",
            "Your first factor credentials are invalid. Please enter valid credentials to proceed.");
    ...
    public static final ResponseCode TV_SERVICE_UNAVAILABLE = new ResponseCode(10, "TV_SERVICE_UNAVAILABLE",
            "The authentication service (TokenValidator) is currently unavailable. Please try again later.");
    ...
    public static final ResponseCode BSIDCA_SERVICE_UNAVAILABLE = new ResponseCode(11, "BSIDCA_SERVICE_UNAVAILABLE",
            "The token management (BSIDCA) service is currently unavailable. Please try again later.");
    ...
    @JsonCreator
    public ResponseCode(@JsonProperty("code") int code, @JsonProperty("name") String name,
    ...
    /**
     * Returns the ResponseCode instance corresponding to the specified HTTP status
     * code.
     *
     ...
     *
     * @throws IllegalArgumentException if the specified code is not found in the
     *                                  ALL_CODES list.
     */
    ...
    public static ResponseCode fromCode(int code) {
        ...
        for (ResponseCode responseCode : ALL_CODES) {
            // If the current ResponseCode instance's code matches the specified code,
            // return it
        ...
        // If no ResponseCode instance with the specified code is found, throw an
        // exception
