...
public class AuthenticationRequest {
	...
	/**
	 * Optional: The challenge state variable. Include this field only if the
	 * response to a previous
	 * challenge request included a state value. Omit this field if this is the
	 * first request in the
	 * authentication flow.
	 */
	...
	/**
	 * Constructs an AuthenticationRequest object with the specified username and
	 * code.
	 *
	 * @param username the username associated with this authentication request
	 * @param code     the code associated with this authentication request, or an
	...
	public AuthenticationRequest(String username, String code) {
		...
		this(username);
		// Set the code of this authentication request to the provided code, or an empty
		// string if null
	...
	public AuthenticationRequest(
		...
		this(username, code);
		// Set the state of this authentication request to the provided state, or an
		// empty string if null
